...
def get_distance_weight(race_dist, race_dist_units="km"):
    """
    :param race_dist: distance of the race (default is km)
    :param race_dist_units: 'km' (default) or 'mi'
    :return: weight as a float
    """
    if RANK_DIST == 0:
        weight = 1
    else:
        if race_dist_units == "mi":
...
def test_predictability(race_result_file):
    ...
    print(f"{race_result_file} {instance_predictability}")
