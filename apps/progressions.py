...
layout = html.Div([
    dcc.RadioItems(id='gender-picker', options=[{'label': 'Men', 'value': 'men'}, {'label': 'Women', 'value': 'women'}], value=default_gender_choice),
    html.Div(dcc.Dropdown(id='name-dropdown', value=['Lea Boy'], multi=True, persistence=True, persistence_type='session'),
